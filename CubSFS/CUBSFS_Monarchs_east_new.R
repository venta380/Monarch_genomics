...
data <- read_table2("Eastpopsize.txt")

ggplot(data) +
  geom_ribbon(aes(x=time,ymin=LCL,ymax=UCL),alpha=0.2,color="black",size=0.1) +
...
ggsave("East.pdf",width=8.7,height=17.8,units="cm")



data <- read_table2("Eastpopsize_200.txt")
...
ggsave("East_200.pdf",width=8.7,height=17.8,units="cm")
